...
import { AchSuccessMetadata } from '../model/Ach';
...
export const SET_OCC_IS_ABC = 'Requesting OCC is ABC';
export const SET_OCC_IS_ABC_FAIL = 'Request OCC is ABC FAIL';
export const SET_OCC_IS_ABC_SUCCESS = 'Request OCC is ABC SUCCESS';
...
export const CHECKOUT_UPDATE_PAYMENT_DETAILS = '[CheckoutCom] Update Payment Details';
export const CHECKOUT_UPDATE_PAYMENT_DETAILS_SUCCESS = '[CheckoutCom] Update Payment Details Success';
export const CHECKOUT_UPDATE_PAYMENT_DETAILS_FAIL = '[CheckoutCom] Update Payment Details Fail';

export const SET_ACH_LINK_TOKEN = 'Setting Ach Link Token';
export const SET_ACH_LINK_TOKEN_SUCCESS = 'Set Ach Link Token SUCCESS';
export const SET_ACH_LINK_TOKEN_FAIL = 'Set Ach Link Token FAIL';

export const SET_ACH_SUCCESS_ORDER = 'Setting Ach Success Order';
export const SET_ACH_SUCCESS_ORDER_SUCCESS = 'Set Ach Success Order SUCCESS';
export const SET_ACH_SUCCESS_ORDER_FAIL = 'Set Ach Success Order FAIL';

export const SET_ACH_SET_ACCOUNT_LIST_SUCCESS = 'Set Ach Set Account List SUCCESS';
export const SET_ACH_SET_ACCOUNT_LIST_FAIL = 'Set Ach Set Account List FAIL';
...
export class SetOccIsABC implements Action {
  readonly type = SET_OCC_IS_ABC;
...
export class SetOccIsABCFail implements Action {
  readonly type = SET_OCC_IS_ABC_FAIL;
...
export class SetOccIsABCSuccess implements Action {
  readonly type = SET_OCC_IS_ABC_SUCCESS;
...
export class CheckoutUpdatePaymentDetails implements Action {
  readonly type = CHECKOUT_UPDATE_PAYMENT_DETAILS;

  constructor(public payload: {userId: string; paymentDetails: CheckoutComPaymentDetails}) {
  }
}

export class CheckoutUpdatePaymentDetailsSuccess implements Action {
  readonly type = CHECKOUT_UPDATE_PAYMENT_DETAILS_SUCCESS;

  constructor(public payload: CheckoutComPaymentDetails) {
  }
}

export class CheckoutUpdatePaymentDetailsFail implements Action {
  readonly type = CHECKOUT_UPDATE_PAYMENT_DETAILS_FAIL;

  constructor(public payload: string) {
  }
}

export class SetAchLinkToken {
  readonly type = SET_ACH_LINK_TOKEN;

  constructor(public payload: { userId: string; cartId: string }) {
  }
}

export class SetAchLinkTokenSuccess {
  readonly type = SET_ACH_LINK_TOKEN_SUCCESS;

  constructor(public payload: string) {
  }
}

export class SetAchLinkTokenFail {
  readonly type = SET_ACH_LINK_TOKEN_FAIL;

  constructor(public payload: HttpErrorResponse) {
  }
}

export class SetAchOrderSuccess {
  readonly type = SET_ACH_SUCCESS_ORDER;
...
export class SetAchOrderSuccessSuccess {
  readonly type = SET_ACH_SUCCESS_ORDER_SUCCESS;

  constructor(public payload: Order) {
  }
}

export class SetAchOrderSuccessFail {
  readonly type = SET_ACH_SUCCESS_ORDER_FAIL;

  constructor(public payload: HttpErrorModel) {
  }
}

export class SetAchAccountListSuccess {
  readonly type = SET_ACH_SET_ACCOUNT_LIST_SUCCESS;

  constructor(public payload: AchSuccessMetadata) {
  }
}

export class SetAchAccountListFail {
  readonly type = SET_ACH_SET_ACCOUNT_LIST_FAIL;
...
export type CheckoutComAction =
  ...
  | CheckoutUpdatePaymentDetails
  | CheckoutUpdatePaymentDetailsSuccess
  | CheckoutUpdatePaymentDetailsFail
  | SetOccIsABC
  | SetOccIsABCFail
  | SetOccIsABCSuccess
  | SetAchLinkToken
  | SetAchLinkTokenSuccess
  | SetAchLinkTokenFail
  | SetAchOrderSuccess
  | SetAchOrderSuccessSuccess
  | SetAchOrderSuccessFail
  | SetAchAccountListSuccess
  | SetAchAccountListFail
  ;
